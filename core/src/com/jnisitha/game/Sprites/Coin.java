...
public class Coin extends InteractiveTileObject{
    ...
    private final int BLANK_COIN = 28;//in tiled indexing starts at 0 and the required tile is 27. libgdx indexes form 1.
    ...
    public void onHeadHit(Mario mario) {
        if (getCell().getTile().getId() == BLANK_COIN){
            ...
            if (object.getProperties().containsKey("mushroom")){//the mushroom custom property is set through Tiled.
